...
function generateRoutes(): BusRoute[] {
  const pairs: [string, string, number][] = [
    ...
    ['Rio de Janeiro', 'São Paulo', 6],
    ['São Paulo', 'Belo Horizonte', 8],
    ['Belo Horizonte', 'São Paulo', 8],
    ['São Paulo', 'Curitiba', 6.5],
    ['Curitiba', 'São Paulo', 6.5],
    ['São Paulo', 'Florianópolis', 10],
    ['Florianópolis', 'São Paulo', 10],
    ['São Paulo', 'Brasília', 12],
    ['Brasília', 'São Paulo', 12],
    ['São Paulo', 'Salvador', 16],
    ['Salvador', 'São Paulo', 16],
    ['Rio de Janeiro', 'Belo Horizonte', 7],
    ['Belo Horizonte', 'Rio de Janeiro', 7],
    ['Rio de Janeiro', 'Brasília', 12],
    ['Brasília', 'Rio de Janeiro', 12],
    ['Rio de Janeiro', 'Salvador', 14],
    ['Salvador', 'Rio de Janeiro', 14],
    ['Rio de Janeiro', 'Vitória', 7.5],
    ['Vitória', 'Rio de Janeiro', 7.5],
    ['Belo Horizonte', 'Brasília', 9],
    ['Brasília', 'Belo Horizonte', 9],
    ['Belo Horizonte', 'Salvador', 12],
    ['Salvador', 'Belo Horizonte', 12],
    ['Belo Horizonte', 'Vitória', 8],
    ['Vitória', 'Belo Horizonte', 8],
    ['Curitiba', 'Florianópolis', 4],
    ['Florianópolis', 'Curitiba', 4],
    ['Curitiba', 'Belo Horizonte', 10],
    ['Belo Horizonte', 'Curitiba', 10],
    ['Salvador', 'Brasília', 13],
    ['Brasília', 'Salvador', 13],
    ['Salvador', 'Fortaleza', 15],
    ['Fortaleza', 'Salvador', 15],
    ['Brasília', 'Fortaleza', 15],
    ['Fortaleza', 'Brasília', 15],
    ['Vitória', 'São Paulo', 10],
    ['São Paulo', 'Vitória', 10],
    ['Vitória', 'Salvador', 14],
    ['Salvador', 'Vitória', 14],
    ['Vitória', 'Brasília', 16],
    ['Brasília', 'Vitória', 16],
    ['Florianópolis', 'Rio de Janeiro', 12],
    ['Rio de Janeiro', 'Florianópolis', 12],
  ];
  ...
  return routes
    ...
    .sort(
      (a, b) =>
        a.date.localeCompare(b.date) || a.origin.localeCompare(b.origin),
    )
    .map((r, i) => ({ ...r, id: i + 1 }));
}
...
export class DatabaseService implements OnModuleInit {
  ...
  private migrate(): void {
    ...
    try {
      this.db.exec(
        "ALTER TABLE bookings ADD COLUMN passenger_email TEXT NOT NULL DEFAULT '';",
      );
    } catch (e) {
    ...
    try {
      this.db.exec(
        "ALTER TABLE bookings ADD COLUMN passenger_phone TEXT NOT NULL DEFAULT '';",
      );
    } catch (e) {
      /* ignores if column already exists */
    }
  ...
  private seedIfEmpty(): void {
    const count = this.db
      .prepare('SELECT COUNT(*) as cnt FROM routes')
      .get() as { cnt: number };
    if (count.cnt > 0) {
      return;
    }
